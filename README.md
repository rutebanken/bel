...
```
  PROVIDERS_BASE_URL=http://localhost:11601/services/providers/ EVENTS_BASE_URL=http://localhost:10001/services/events/ MARDUK_BASE_URL=http://localhost:11002/ npm start dev
```
...
```
AUTH_SERVER_URL=https://test.rutebanken.org/auth PORT=9000 PROVIDERS_BASE_URL=http://localhost:11601/services/providers/  EVENTS_BASE_URL=http://localhost:10001/services/events/ MARDUK_BASE_URL=http://localhost:11002/ npm start dev
 npm run dev
```
